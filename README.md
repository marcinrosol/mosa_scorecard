...
Converting analog (paper and pencil) golf scorecard to a digital table and database entries. 

[Devpost](https://devpost.com/software/scorecard-digitizer?ref_content=user-portfolio&ref_feature=in_progress)

### Authors

* **Name** - marcinr630 – marcinr@seas.upenn.edu – [GitHub](https://github.com/marcinrosol)
